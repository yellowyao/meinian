...
public class SMSUtils {
    ...
    private static final String SECRETID="AKIDIiVwTps6765mvK8dAsHEyIR4WonC1F2zQdqw";
    private static final String SECRETKET="68dmhFqxddjo9dbikLPs1t5scz9B8bLxm7u8ny6u";
    /**
     * 发送短信
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws Exception {
        ...
        queryParams.put("content",param);
        queryParams.put("mobile",phoneNumbers);
        // body参数
